...
public class PorLeerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_por_leer, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycleviewLibraryPorLeer);
    ...
    private void dataInitialize(){
        ApiResponse apiResponseBooks = BookService.findLibrary(2,CurrentUser.getInstance().getIdUsuario());
